...
@mcp.tool()
async def search_procedures_by_keyword(query: str, limit: int = 5) -> str:
    """
...
@mcp.tool()
async def index_procedure_data(procedure_id: int) -> str:
    """
...
@mcp.tool()
async def get_indexed_procedure(procedure_id: int) -> str:
    """
...
@mcp.tool()
async def get_indexed_requirements(procedure_id: int) -> str:
    """
